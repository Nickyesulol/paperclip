...
export function IssueRow({
  ...
  return (
    <Link
      ...
      className={cn(
        "group flex items-start gap-2 border-b border-default-200/30 py-2.5 pl-2 pr-3 text-sm no-underline text-inherit transition-colors last:border-0 sm:items-center sm:py-2 sm:pl-1",
